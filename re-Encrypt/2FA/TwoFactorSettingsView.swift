...
struct TwoFactorSettingsView: View {
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                FeaturesRow(
                    ...
                    description: "Use Google Authenticator, Authy, 1Password, or similar"
                )
    ...
    private func handlePendingAction() {
        ...
        case .disable:
            disableTwoFactor(passwordData: passwordData)
        case .viewCodes:
    ...
    private func disableTwoFactor(passwordData: Data) {
        guard TwoFactorAuthManager.shared.disable(masterPassword: passwordData, context: viewContext) else {
