...
class TwoFactorAuthManager {
    ...
    func disable(masterPassword: Data, context: NSManagedObjectContext) -> Bool {
        guard CryptoHelper.verifyMasterPassword(password: masterPassword, context: context) else {
            return false
        }
