...
// MARK: - Enhanced Sidebar Components
...
struct SidebarView: View {
    ...
    private func folderGridTile(folder: Folder) -> some View {
        ...
        let name = CoreDataHelper.decryptedFolderName(folder) ?? "Folder"
...
// MARK: - Enhanced Sidebar Selection with 2FA
