...
struct PasswordDetailsView: View {
    ...
    // MARK: - 2FA Display Section - IMPLEMENTED
    @ViewBuilder
...
struct PasswordDetailsView: View {
    ...
    private func saveInlineChanges(for entry: PasswordEntry) {
        ...
        CoreDataHelper.upsertPassword(
            ...
            passwordData: passwordToUse,
            category: entry.category ?? "Other",
            notes: editableEntry.notes.isEmpty ? nil : editableEntry.notes,  // NEW
            isFavorite: editableEntry.isFavorite,                            // NEW
            passwordExpiry: entry.passwordExpiry,                            // NEW - preserve
            tags: tagsString,                                                // NEW
            context: context
        )
