...
//MARK: - END Custom list
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    if let folder = selectedFolder {
                        let folderName = CoreDataHelper.decryptedFolderName(folder) ?? "Folder"
    ...
    private func passwordFieldSecure() -> some View {
        ZStack(alignment: .trailing) {
            ...
            HStack(spacing: 8) {
                ...
                Button { copyPasswordToClipboard() } label: {
    ...
    private func copyPasswordToClipboard() {
        ...
        NSPasteboard.general.setString(passwordString, forType: .string)
